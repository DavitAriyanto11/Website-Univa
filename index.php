...
<head>
    ...
    <title>Siakad Universitas Alifah Padang</title>
	<!-- BOOTSTRAP STYLES-->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/univa.jpg" class="user-image img-responsive"/>
                     <h3 style="color: blue;">Sistem Informasi Akademik Universitas Alifah Padang</h3>
					</li>
                    ...
                    <li  >
                        <a  href="?page=jadwal"><i class="glyphicon glyphicon-th-list"></i>Jadwal Mengajar </a>
                    </li>
