...
$sql6 = $koneksi->query("select * from tb_mahasiswa where kode_jurusan ='MNJ'");
$sql7 = $koneksi->query("select * from tb_mahasiswa where kode_jurusan ='KWU'");
$TI=$sql4->num_rows;
$SI=$sql5->num_rows;
$MNJ=$sql6->num_rows;
$KWU=$sql7->num_rows;
...
?>
 ...
 <marquee>Selamat Datang di Sistem Informasi Akademik Universitas Alifah Padang JL. Khatib Sulaiman No.52 B, Kota Padang, Sumatera Barat, Indonesia 25134</marquee>


<div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2 style="color: blue;">Halaman Utama</h2>   
                        <h5>Sistem Informasi Akademik Univa</h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
	    ...
	    ["Manajemen Ritel", <?php echo $MNJ; ?>, "green"],
	    ["Kewirausahaan", <?php echo $KWU; ?>, "yellow"],
